...
func Register(ctx context.Context, bot *tele.Bot, handler *handlers.Handler) <-chan struct{} {
	...
	bot.Handle("/report", handler.PrivateOnly(handler.HandleReport))
	...
	bot.Handle(&tele.Btn{Unique: "schedule_period_date"}, handler.HandleSchedulePeriodDateSelect)
	...
	bot.Handle(&tele.Btn{Unique: "open_schedule_exports"}, handler.HandleOpenScheduleExports)
	bot.Handle(&tele.Btn{Unique: "back_to_schedule"}, handler.HandleBackToSchedule)
	bot.Handle(&tele.Btn{Unique: "download_schedule"}, handler.HandleDownloadSchedule)
	bot.Handle(&tele.Btn{Unique: "download_schedule_png"}, handler.HandleDownloadSchedulePNG)
	bot.Handle(&tele.Btn{Unique: "download_schedule_ics"}, handler.HandleDownloadScheduleICS)
	...
	bot.Handle(&tele.Btn{Unique: "cancel_group_change"}, handler.HandleCancelGroupChange)
	bot.Handle(&tele.Btn{Unique: "set_default_subscription"}, handler.HandleSetDefaultSubscription)
	bot.Handle(&tele.Btn{Unique: "schedule_view_settings"}, handler.HandleScheduleViewSettings)
	bot.Handle(&tele.Btn{Unique: "set_schedule_view"}, handler.HandleSetScheduleView)
	bot.Handle(&tele.Btn{Unique: "subgroup_settings"}, handler.HandleSubgroupSettings)
	bot.Handle(&tele.Btn{Unique: "set_subscription_subgroup"}, handler.HandleSetSubscriptionSubgroup)
	bot.Handle(&tele.Btn{Unique: "subscription_schedule"}, handler.HandleSubscriptionSchedule)
	...
	bot.Handle(&tele.Btn{Unique: "confirm_sub_delete"}, handler.HandleConfirmDeleteSubscription)
	bot.Handle(&tele.Btn{Unique: "cancel_sub_delete"}, handler.HandleCancelDeleteSubscription)
	...
	bot.Handle(&tele.Btn{Unique: "help_topic"}, handler.HandleHelpTopic)
	bot.Handle(&tele.Btn{Unique: "confirm_primary_group"}, handler.HandleConfirmPrimaryGroup)
	bot.Handle(&tele.Btn{Unique: "schedule_feedback"}, handler.HandleScheduleFeedback)
	...
	bot.Handle(&tele.Btn{Unique: "cancel_unset_chat_group"}, handler.HandleCancelUnsetChatGroup)
	bot.Handle(&tele.Btn{Unique: "set_chat_schedule_view"}, handler.HandleSetChatScheduleView)
