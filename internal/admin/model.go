...
type SourceView struct {
	...
	IdentityConflicts         []domain.GroupIdentityConflict `json:"identity_conflicts" db:"-"`
...
type GroupView struct {
	...
	UniversityName    string    `json:"university_name" db:"university_name"`
	IsActive          bool      `json:"is_active" db:"is_active"`
	SourceActive      bool      `json:"source_active" db:"source_active"`
	ManuallyDisabled  bool      `json:"manually_disabled" db:"manually_disabled"`
	LessonCount       int       `json:"lesson_count" db:"lesson_count"`
	SubscriptionCount int       `json:"subscription_count" db:"subscription_count"`
	DefaultGroupCount int       `json:"default_group_count" db:"default_group_count"`
	ChatCount         int       `json:"chat_count" db:"chat_count"`
	OverrideCount     int       `json:"override_count" db:"override_count"`
